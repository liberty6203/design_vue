<template>
    <div>
        ...
        <!-- 编辑弹出框 -->
        <el-dialog title="论文审核" :visible.sync="editVisible"  width="30%">
...
<script>
import { getList,detail,audit } from '../../api/treatiseAudit.js'
